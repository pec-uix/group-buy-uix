  ...
  >
    ...
    >
      <div class="d-flex flex-grow-1 align-start">
        ...
        <div class="d-flex flex-column justify-space-between flex-grow-1 pl-4">
          <v-btn
            elevation="0"
            fab
            dark
          ...
          <div class="pec-product-card-title text-caption">
            {{ product.product_name }}
          </div>
          <div class="primary--text pec-product-card-price">
      ...
      <v-row no-gutters class="pt-1">
        <v-col cols="12">
          <template v-if="isLogin && isVerified">
            <div class="text-h6 d-flex justify-space-between align-end">
              <div class="d-flex">
                <span
              ...
              <div class="d-flex">
                ...
                <v-btn
                  ...
                  text
                  color="primary"
                  class="d-flex align-center ml-1 pt-1"
                  @click.stop.prevent="
                    $store.dispatch('setCartProduct', product.product_id)
                  "
                >
                  <i
