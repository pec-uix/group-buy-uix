    ...
    <v-card>
      ...
      <v-tabs-items v-model="tab">
        <div v-if="tab === 'tab-0'">
          ...
          <div class="d-flex align-center mb-2 pr-3" style="gap: 8px; flex-wrap: wrap; padding-left: 12px;">
            <!-- 篩選下拉選單：放最左方 -->
            <v-menu
              v-if="currentTab == 0"
              offset-y
            ...
            >
              <template v-slot:activator="{ on, attrs }">
                <v-btn
                  ...
                  v-on="on"
                >
                  <span style="flex: 1; text-align: left;">{{ readStatus }}</span>
                  <v-icon small style="color: #4B5563 !important;">fa-solid fa-caret-down</v-icon>
                </v-btn>
              </template>
              <v-list dense>
                <v-list-item
                ...
                >
                  <v-list-item-title
                    :class="item.text == readStatus ? 'primary--text font-weight-bold' : ''"
            ...
            <!-- 轉贈：在「可使用」分類時顯示，靠右 -->
            <v-btn
              v-if="currentTab == 0 && readStatus == '可使用'"
              class="ma-0"
              color="primary"
              depressed
