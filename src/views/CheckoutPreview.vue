      ...
      <v-card class="return-policy-dialog pa-4">
        <v-card-text class="text-center pb-2 pt-2">
          ...
          <div class="black--text" style="font-size:16px">
            您尚未勾選［我同意辦理退貨時，由團購網代為處理發票及銷貨退回證明單，以加速退貨退款作業。線上支付退款作業完成後，款項約 7 ~ 14 個工作天退刷。（實際仍以銀行作業為主）］
          </div>
        </v-card-text>
...
export default {
  ...
  created() {
    ...
    // DEV: bypass auth/cart guards and inject mock data for UI preview
    if (import.meta.env.DEV) {
      ...
      const mockPayments = [
        ...
        { payment_tool: 'ATM' },
        { payment_tool: 'SUPER' },
        { payment_tool: 'LINE_PAY' },
      ]
      this.checkoutItemArray = [
        {
          id: 1,
          product_id: 'MOCK001',
          img_url: 'https://picsum.photos/seed/product1/200/200',
          is_spcloff_product: 'N',
          product_name: '嚴選有機蔬果禮盒（6入）',
          spec_name: '標準規格',
          receive_type: '2',
          receive_area_name: '',
          discount_price: 1200,
          order_num: 2,
          discount_for_checkout_item: 0,
          payment_tool_array: mockPayments,
          category_secondary_array: [],
          activity_type_array: ['GROUP_BUY'],
          category_id_array: ['1'],
          reward_exclude: 'N',
          reward_usable: [],
        },
        {
          id: 2,
          product_id: 'MOCK002',
          img_url: 'https://picsum.photos/seed/product2/200/200',
          is_spcloff_product: 'Y',
          product_name: '加價購-保鮮袋組合',
          spec_name: 'M號 10入',
          receive_type: '2',
          receive_area_name: '',
          discount_price: 199,
      ...
      this.commonPayments = mockPayments
      this.paymentTypeArray = [
        { payment_type: '2', payment_type_name: '線上支付' },
        { payment_type: '1', payment_type_name: '取貨點繳費' },
        { payment_type: '3', payment_type_name: '銀行匯款' },
        { payment_type: '5', payment_type_name: '貨到付款' },
      ]
      this.receiveTypeArray = [{ value: '2', text: '宅配' }]
      this.receiveType = '2'
      this.shipment = 60
      this.rewardForAll = []
